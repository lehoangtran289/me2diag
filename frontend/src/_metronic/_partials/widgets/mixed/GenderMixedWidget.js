...
import {useEffect, useMemo} from "@types/react";
...
export function GenderMixedWidget({ className, ...props }) {
  ...
  return (
    <div className={`card card-custom ${className}`}>
      ...
      <div className="card-header border-0 pt-5">
        <h3 className="card-title font-weight-bolder ">Gender proportion</h3>
