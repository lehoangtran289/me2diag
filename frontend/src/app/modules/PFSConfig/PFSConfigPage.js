...
import {getAllPFSHedgeConfigs, getAllPFSLinguisticDomainConfigs, savePFSHedgeConfigs} from "./_redux/PFSConfigCrud";
              ...
              <div className="form-group row">
                ...
                <div className="col-xl-9 col-lg-9">
                  <div className="row">
                    <div className="col-9">
                      <Slider
                        value={typeof formik.values.SLIGHTLY === "number" ? formik.values.SLIGHTLY : 0.0}
                        onChange={(event, newValue) => {
                          formik.setFieldValue("SLIGHTLY", newValue);
                        }}
                        min={0.0}
                        max={1.0}
                        step={0.01}
                    ...
                    <div className="col-3">
                      <input
                        ...
                        className={`form-control form-control-lg form-control-solid`}
                        onChange={(event) => {
                          formik.setFieldValue("SLIGHTLY", event.target.value ? Number(event.target.value) : 0.0);
                        }}
                        {...formik.getFieldProps("SLIGHTLY")}
                      />
                      {formik.touched.SLIGHTLY && formik.errors.SLIGHTLY ? (
                        <div className="invalid-feedback">
                          {formik.errors.SLIGHTLY}
                        </div>
                      ) : null}
                    </div>
                  </div>
